...
public interface QuotationExceptions {
  ...
  @ResponseStatus(code = HttpStatus.NOT_ACCEPTABLE, reason = "quotation.already.exists.exception")
  class AlreadyExistsException extends RuntimeException {

    private static final long serialVersionUID = 1L;
  }

  @ResponseStatus(code = HttpStatus.NOT_ACCEPTABLE, reason = "quotation.code.already.exists.exception")
