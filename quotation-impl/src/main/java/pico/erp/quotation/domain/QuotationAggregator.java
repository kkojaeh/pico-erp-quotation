...
public class QuotationAggregator extends Quotation {
  ...
  public QuotationMessages.VerifyResponse apply(QuotationMessages.VerifyRequest request) {
    ...
    return new QuotationMessages.VerifyResponse(Collections.emptyList());
  }
}
